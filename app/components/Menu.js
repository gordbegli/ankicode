...
export default function Menu({ current, cards, answer, difficultyRating, rate, videoHtml, problemDescription, testCode, rating, setRating, goToNextProblem, pattern, patterns, vimMode, setVimMode }) {
    ...
    const renderTabContent = () => {
        switch (activeTab) {
            ...
            case 'settings': return (<div className={styles.tabContent}><Settings cards={cards} pattern={pattern} patterns={patterns} vimMode={vimMode} setVimMode={setVimMode} /></div>);
            default: return null;
        }
    };
